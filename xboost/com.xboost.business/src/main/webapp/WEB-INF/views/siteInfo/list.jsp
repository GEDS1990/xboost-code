                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            网点信息列表
                            <a href="javascript:;" id="showModal" class="btn btn-success btn-xs pull-right"><i class="fa fa-plus"></i> 新增</a>
                        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/siteInfo/add" method="post" id="newTaskForm">
                    <div class="form-group">
                        <label>网点编码</label>
                        <input type="text" name="siteCode" class="form-control" id="siteCode">
                        <label>网点名称</label>
                        <input type="text" name="siteName"  class="form-control" id="siteName">
                        <label>网点地址</label>
                        <input type="text" name="siteAddress" class="form-control" id="siteAddress">
...
<script>
    $(function(){
        ...
        //删除已完成
        $(document).delegate(".deleteUnLink","click",function(){
            alert("删除已完成！");
            var $this = $(this);
            var id = $this.attr("rel");
            $.post("/task/state/delete",{"taskId":id}).done(function(result){
