...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="page-header">需求信息管理</h4>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table class="table" id="DemandInfoTable">
                                <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>日期</th>
...
<script>
    $(function(){
debugger;
        var dt = $("#DemandInfoTable").DataTable({
            ...
            "columns":[  //返回的JSON中的对象和列的对应关系
                {"data":"id","name":"id"},
                {"data":"date","name":"date"},
                {"data":"siteCodeCollect","name":"site_collect"},
                {"data":"siteCodeDelivery","name":"site_delivery"},
