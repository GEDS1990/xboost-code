...
import com.xboost.service.TaskService;
...
public class CustomerController {
     ...
     * @return
     */
    @RequestMapping(value = "/get/{id:\\d+}",method = RequestMethod.POST)
    @ResponseBody
     ...
     * @return
     */
    @RequestMapping(value = "/customer.json",method = RequestMethod.POST,produces = "application/json;charset=UTF-8")
    @ResponseBody
    public Map<String,Object> editCustomer(Integer id) {
        Map<String,Object> result = Maps.newHashMap();
        try {
