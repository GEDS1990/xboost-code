...
public class TransportService {
    ...
    private Logger logger = LoggerFactory.getLogger(TransportService.class);

    /**
     * 保存新运力信息
     * @param transport
     */
    public void saveTransport(Transportation transport) {
    ...
    //通过Excel新增运力信息
    public void addTransportByExcel(Transportation transport,MultipartFile[] file) {
        //判断文件集合是否有文件
...
//                        File fileTemp = (File) multipartFile;
     ...
     * @return
     */
    public List<Transportation> findByParam(Map<String, Object> param) {
     ...
     * @param transport
     */
    public void editTransport(Transportation transport) {
