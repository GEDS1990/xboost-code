...
public class RoutingTransportCosts implements ITransportCosts,IConstants,Serializable{
	...
	public RoutingTransportCosts(String distance, String nearest, double fixedStopTime, boolean isSymmetric,int distMode) {
...
//		this.fixedStopTime = fixedStopTime;
	...
	public double calcDistance(String from, String to) {
		...
		if(mode == 2){
			Location loc1 = Main.locs.get(from);
			Location loc2 = Main.locs.get(to);
