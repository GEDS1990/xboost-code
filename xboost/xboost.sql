...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`xboost` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
CREATE TABLE `t_user` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `weixinid` varchar(45) DEFAULT NULL COMMENT '微信号',
