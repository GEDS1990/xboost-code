...
public class SolutionCostService {
    ...
    public Double branchTransportCost()
    {
        ...
        for(int i=0;i<routeCountList.size();i++){
            ...
            int a1=Integer.parseInt(car.getA1());
            int a2=Integer.parseInt(car.getA2());
            int b1=Integer.parseInt(car.getB1());
            int b2=Integer.parseInt(car.getB2());
            int c1=Integer.parseInt(car.getC1());
            int c2=Integer.parseInt(car.getC2());
            int d1=Integer.parseInt(car.getD1());
            int d2=Integer.parseInt(car.getD2());
            int e1=Integer.parseInt(car.getE1());
            int e2=Integer.parseInt(car.getE2());
            int f1=Integer.parseInt(car.getF1());
            int f2=Integer.parseInt(car.getF2());

            Double costa1=Double.parseDouble(car.getCosta1());
            Double costa2=Double.parseDouble(car.getCosta2());
            Double costa3=Double.parseDouble(car.getCosta3());
            Double costb1=Double.parseDouble(car.getCostb1());
            Double costb2=Double.parseDouble(car.getCosta2());
            Double costb3=Double.parseDouble(car.getCostb3());
            Double costc1=Double.parseDouble(car.getCostc1());
            Double costc2=Double.parseDouble(car.getCostc2());
            Double costc3=Double.parseDouble(car.getCostc3());
            Double costd1=Double.parseDouble(car.getCostd1());
            Double costd2=Double.parseDouble(car.getCostd2());
            Double costd3=Double.parseDouble(car.getCostd3());
            Double coste1=Double.parseDouble(car.getCoste1());
            Double coste2=Double.parseDouble(car.getCoste2());
            Double coste3=Double.parseDouble(car.getCoste3());
            Double costf1=Double.parseDouble(car.getCostf1());
            Double costf2=Double.parseDouble(car.getCostf2());
            Double costf3=Double.parseDouble(car.getCostf3());
