...
//	 public static  Map<Integer, List<CarrierRecords>> groupByTimeId(List<CarrierRecords> carrierList) {
//		 Map<Integer, List<CarrierRecords>> recordsGrouping = carrierList.stream().collect(
//		            Collectors.groupingBy(CarrierRecords::getTimeId));
//
//	     return recordsGrouping;    
//	    }
